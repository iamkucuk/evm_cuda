...
EXPECTED_ROOT = {
    ...
    "magnify", "PRESETS", "Preset", "presets",
    ...
    "BINOM5", "BINOM5_SUM1", "blur_dn", "blur_dn_clr", "build_lpyr",
    "recon_lpyr", "laplacian_pyramid_channels", "reconstruct_from_channels",
    "max_pyr_ht",
    # Temporal building blocks.
    "ideal_bandpass", "butter_bandpass", "iir_bandpass",
...
@pytest.mark.parametrize("module", [
    "evm.backend", "evm.cpu", "evm.cpu.ops", "evm.io", "evm.presets",
])
