"""The Metal implementation of :class:`evm.backend.Ops`.
...
magnification pipelines come from :mod:`evm.backend.generic` without being
written again.
...
class MetalOps:
    ...
    def _colour_matrices(self) -> dict[str, bytes]:
        ...
        Taken from :mod:`evm.io.video` rather than written into the kernel, so
