"""The PyTorch implementation of :class:`evm.backend.Ops`.
...
# cannot drift from `evm.io.video` the way a copied literal would.
...
class TorchOps:
    ...
    def butter_bandpass(
        ...
        The coefficients come from SciPy through :mod:`evm.cpu.filters` rather
