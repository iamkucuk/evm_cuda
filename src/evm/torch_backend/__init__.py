...
whole-clip work on the same card the hand-written backend is 2.8 times faster
(239 ms against 664 ms for a 301-frame clip), which is why automatic selection
