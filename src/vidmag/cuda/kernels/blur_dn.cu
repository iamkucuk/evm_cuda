...
//
// Port of vidmag/cpu/pyramids.py:blur_dn / blur_dn_clr, which mirror matlabPyrTools
...
// at every call (vidmag/cpu/pyramids.py:129), which is a no-op for BINOM5_SUM1 but
