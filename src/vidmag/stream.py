...
def _operations_for(name: str, impl: Any) -> Any:
    ...
    # alone is not enough: vidmag.cuda is a package with a submodule called `ops`,
    # so it passed that test and then failed several calls later with
    # AttributeError: module 'vidmag.cuda.ops' has no attribute 'from_numpy'.
    ...
    raise NotImplementedError(
        ...
        + ", ".join(
            i.name
            for i in __import__(
                "vidmag.backend", fromlist=["registry"]
